...
<body>
	...
	<div class="bg-light m-2 border-secondary mt-5">
		<div id="farewell_note" class="m-3 mt-2 pb-2 display-4"><strong class="">Dear User!</strong> Your valuable feedback has been submitted to SGRH. We thank you for sparing few moments to evaluate our services. It help us to be better.</div>
