...
<body>
	...
	$(document).ready( e => {
		...
		if(screenSize < 700){
			$("#middle_col").replaceWith("<div id='middle_col' class='col-4'><h6 class='text-center display-5'>Sir Ganga Ram Hospital</h6><p class='text-center'>Patient Health Report.</p></div>");
