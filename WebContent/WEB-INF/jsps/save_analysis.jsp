...
<title>Patient Analysis Saved</title>
...
<body>
	...
	<div class="bg-light m-2 border-secondary mt-5">
		<div id="farewell_note" class="m-3 mt-2 pb-2 display-4"><strong class="">Dear User!</strong> Patient Analysis information of ${date} stored into the system on ${time}.</div>
	...
	$(document).ready( e => {
		...
		$("#home_icon").click( e =>{
			window.location.href = "patient_analysis_control";
		});
